...
def download_button(object_to_download, download_filename, button_text, key):
    ...
    st.download_button(
        label=button_text,
        key=download_key,
        on_click=object_to_download,
        args=(download_filename,),
        help="Нажмите, чтобы скачать файл",
    )
            ...
            with col1_2:
                ...
                genre = st.radio("**Выберите график**",
                                 ["Количественное соотношение",
                                  "Количественное соотношение (отрезки по оси X)",
                                  "Процентное соотношение"])

                if genre == "Количественное соотношение (отрезки по оси X)":
